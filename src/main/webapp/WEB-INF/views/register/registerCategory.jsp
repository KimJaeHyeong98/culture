      ...
      <div class="register-main">
        <div class="register-form">
          ...
          <div class="content-box">
            ...
            <button class="load-button" data-type="MOVIE">
              카테고리 없는 영화 불러오기
            </button>
          </div>
          ...
          <div class="content-box">
            ...
            <button class="load-button" data-type="ANIME">
              카테고리 없는 애니 불러오기
            </button>
          </div>
          ...
          <div class="content-box">
            ...
            <button class="load-button" data-type="GAME">
              카테고리 없는 게임 불러오기
            </button>
          </div>
          ...
          <div class="content-box">
            <h3>영화</h3>
            <ul id="moviecast-list">
              <!-- 영화 항목들이 여기에 비동기로 추가됨 -->
            </ul>
            <button class="load-button" data-type="MOVIECAST">
              출연진 없는 영화 불러오기
            </button>
          </div>
        </div>
    ...
    <div id="categoryModal" class="modal hidden">
      <div class="modal-content">
        <form id="categoryForm">
          ...
          <input type="hidden" id="selectedMovieCastId" />
          ...
          <!-- 출연진 선택 -->
          <div id="castCategoryWrapper" style="display: none">
            <h3>출연진 선택</h3>
            <select
              id="castCategorySelect"
              name="castCategoryId"
              class="category-select"
            >
              <option value="">-- 출연진 선택 --</option>
              <!-- <option value="101">주연</option>
          <option value="102">조연</option>
          <option value="103">특별출연</option> -->
            </select>
          </div>

          <!-- 버튼 영역 -->
          <div style="margin: 10px 0">
            <button type="button" onclick="addCategorySelect()">＋ 추가</button>
            <button type="button" onclick="removeCategorySelect()">
              − 삭제
            </button>
          </div>
